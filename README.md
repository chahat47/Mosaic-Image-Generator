...
### Example Mosaic Output

> A high-resolution mosaic generated by the app — the target image reconstructed entirely from smaller tile images, each matched by average RGB color.

![Example Mosaic Output](k.jpg)

*The mosaic above demonstrates the tile-matching accuracy achievable with the default 30×30 tile size setting. Zoom in to see individual tiles.*
